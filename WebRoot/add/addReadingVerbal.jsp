 ...
 <body>
	<div class="container">
		...
		<div class="content">
			...
			<div class="context">
			<div id = "title"><a>Add Argument :</a> </div>
			<div id ="clock" ><h1 id="clock"></h1></div>
				<div id="show">
					...
					<table id="tableAdd">
						...
						<tr>
								<td>Question :</td>
								<td colspan="2"><input type="textarea" name="question"/><br/></td>
						</tr>
						
						<tr>
								<td>Choice (separated by ";") :</td>
								<td colspan="2"><input type="textarea" name="passage"/><br/></td>
						</tr>
						
						<tr>
								<td>Answers :</td>
								<td colspan="3"><input type="textarea" name="answere"/><br/></td>
						</tr>
						<tr>
								<td>Answer Info :</td>
